...
def run_full_analysis():
    ...
    try:
        ...
        logger.info(f"Data loaded: {pipeline.data.shape[0]} observations, {pipeline.data.shape[1]} variables")
        logger.info(f"Countries: {pipeline.data[pipeline.unit_col].nunique()}")
        logger.info(f"Time period: {pipeline.data[pipeline.time_col].min()}-{pipeline.data[pipeline.time_col].max()}")
        ...
        logger.info(f"  - Treatment adoption timeline created")
        logger.info(f"  - Outcome trends by cohort plotted")
        logger.info(f"  - Treatment balance checked")
        ...
        logger.info(f"  - Dynamic treatment effects estimated")
        logger.info(f"  - Event study plots generated")
        ...
        logger.info(f"  - Alternative estimators tested")
        logger.info(f"  - Sample robustness verified")
        logger.info(f"  - Placebo tests conducted")
