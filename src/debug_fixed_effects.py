...
def debug_fixed_effects():
    ...
    rhs_vars = ['gdp_pc_constant_log', 'urban_pop_pct', 'event_time_lead_3', 'event_time_lead_2', 'event_time_0', 'event_time_lag_1', 'event_time_lag_2', 'event_time_lag_3']
    ...
    for var in rhs_vars:
        if var in data_with_dummies.columns:
            ...
            try:
                ...
                converted_nans = numeric_vals.isna().sum() - data_with_dummies[var].isna().sum()
